...
<section class = "bg-white min-h-screen flex items-center justify-center">
    <div class ="bg-[#B1D7E7]  flex rounded-2xl overflow-hidden shadow-lg max-w-6xl p-5">
      ...
      <div class="w-10/12">
        <h2 class ="font-bold text-4xl text-[#07085B] ">Login Student</h2>
      
       <!-- form -->
        <form action ="./login.student.php" method="post" class="flex flex-col gap-4">
        ...
        <div class="mt-4 text-xs flex justify-between items-center">
            ...
            <p class="text-[#5C789B]">Login As a Admin</p>
           <a href="./index.php"> <button class="py-2 px-2 bg-white border rounded-xl text-[#5C789B] border-gray-200 hover:scale-110 duration-300">Admin</button></a>
        </div>
      </div>
       <!-- devider1 -->
