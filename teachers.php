    ...
    <aside class="fixed inset-y-0 flex-wrap items-center justify-between block w-full p-0 my-4 overflow-y-auto antialiased transition-transform duration-200 -translate-x-full bg-white border-0 shadow-xl   max-w-64 ease-nav-brand z-990 xl:ml-6 rounded-2xl xl:left-0 xl:translate-x-0" aria-expanded="false">
      ...
      <div class="items-center block w-auto max-h-screen overflow-auto h-auto grow basis-full">
        <ul class="flex flex-col pl-0 mb-0">
          ...
          <li class="mt-0.5 w-full">
            <a class="   py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 font-semibold rounded-lg text-slate-700 bg-blue-500/13 transition-colors" href="./teachers.php">
              <div class="mr-2 flex h-10 w-10 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
          ...
          <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
            <nav>
              ...
              <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                ...
                <li class="text-sm pl-2 capitalize leading-normal text-white before:float-left before:pr-2 before:text-white before:content-['/']" aria-current="page">Teachers</li>
              </ol>
              <h6 class="mb-0 font-bold text-white capitalize">Teachers</h6>
            </nav>
  ...
  <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
    <thead class="bg-gray-50">
      <tr>
        ...
        <th scope="col" class="px-6 py-4 font-medium text-gray-900">Teacher_ID</th>
        <th scope="col" class="px-6 py-4 font-medium text-gray-900">Subject</th>
        <th scope="col" class="px-6 py-4 font-medium text-gray-900">Mobile No.</th>
    ...
    <tbody class="divide-y divide-gray-100 border-t border-gray-100">
      <tr class="hover:bg-gray-50">
        ...
        <td class="px-6 py-4"><?php echo $row['techer_id']; ?></td>
        ...
        <td class="px-6 py-4">
          <div class="flex justify-end gap-4">
            <a x-data="{ tooltip: 'Delete' }" href="./student_remove.php?id=<?php echo $row['techer_id']; ?>" onclick = 'return checkdelete()' >
            <input type='hidden' >
              <svg
            ...
            <a x-data="{ tooltip: 'Edite' }" href="./student_update_form.php?id=<?php echo $row['techer_id']; ?>" >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
